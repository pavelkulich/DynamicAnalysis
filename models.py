...
class Model:
    ...
    def calculate_model(self, params):
        ...
        elif self.type == 'dynamic_single_winkler_moment':
            return self.dynamic_single_winkler_moment(params)
    ...
    def winkler_moment(self, params):
        ei = params[0]
        k = params[1]
        q = params[2]
    ...
    def dynamic_single_winkler_moment(self, params):
        ei = params[0]
        k = params[3]
        c = params[2]
        m = params[1]
